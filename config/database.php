...
return [
    ...
    */
    ...
    'connections' => [
        ...
        'mysql_systemone_module' => [
            'driver' => 'mysql',
            'url' => env('DATABASE_URL'),
            'host' => env('DB_HOST_SYSTEMONE_MODULE', '192.168.3.240'),
            'port' => env('DB_PORT_SYSTEMONE_MODULE', '3306'),
            'database' => env('DB_DATABASE_SYSTEMONE_MODULE', 'forge'),
            'username' => env('DB_USERNAME_SYSTEMONE_MODULE', 'forge'),
            'password' => env('DB_PASSWORD_SYSTEMONE_MODULE', ''),
            'unix_socket' => env('DB_SOCKET', ''),
            'charset' => 'utf8',
            'collation' => 'utf8_unicode_ci',
            'prefix' => '',
        ...
        'mysql_rapid_module' => [
            'driver' => 'mysql',
            'url' => env('DATABASE_URL'),
            'host' => env('DB_HOST_RAPID_MODULE', '192.168.3.235'),
            'port' => env('DB_PORT_RAPID_MODULE', '3306'),
            'database' => env('DB_DATABASE_RAPID_MODULE', 'forge'),
            'username' => env('DB_USERNAME_RAPID_MODULE', 'forge'),
            'password' => env('DB_PASSWORD_RAPID_MODULE', ''),
            'unix_socket' => env('DB_SOCKET', ''),
            'charset' => 'utf8',
            'collation' => 'utf8_unicode_ci',
            'prefix' => '',
